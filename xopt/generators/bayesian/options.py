...
from pydantic import BaseModel, create_model, Field, root_validator, Extra
...
from xopt.pydantic import JSON_ENCODERS, XoptBaseModel, check_and_set_options
...
class BayesianOptions(GeneratorOptions):
    ...
    def partial_update(self, new_kwargs: dict) -> 'BayesianOptions':
        ...
        check_and_set_options(self, updated_dict)
        return self
