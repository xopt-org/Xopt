...
def test_feasibility_variants(
    ...
    # Basic feasibility
    X = torch.zeros(2, 1, 3)
    with patch("xopt.generators.bayesian.objectives.get_sampler", return_value=dummy_sampler), \
         patch("xopt.generators.bayesian.objectives.FeasibilityObjective", dummy_feasibility_objective):
    ...
    with patch("xopt.generators.bayesian.objectives.get_sampler", return_value=dummy_sampler), \
         patch("xopt.generators.bayesian.objectives.FeasibilityObjective", dummy_feasibility_objective):
        result3 = feasibility(X3, dummy_model, dummy_vocs, posterior_transform=posterior_transform)
