...
def test_nsga2_output_data():
    ...
    with TemporaryDirectory() as output_dir:
        ...
        expected_columns = ['x1', 'x2', 'y1', 'y2', 'c1', 'c2', 'xopt_runtime', 
                           'xopt_error', 'xopt_parent_generation', 'xopt_candidate_idx']
...
def test_nsga2_checkpoint_reload():
    ...
    with TemporaryDirectory() as output_dir:
        ...
        restored_generator = NSGA2Generator.from_dict({"vocs": tnk_vocs, **checkpoint_data})
