...
from xopt.evaluators.gpt_evaluate import evaluate_gpt, archive_gpt
...
evaluate_options.update(config['gpt_config'])
...
toolbox.register('evaluate', evaluate_gpt, **evaluate_options)
toolbox.register('archive', archive_gpt)
